...
export default function Manager({ user }) {
  ...
  return (
    <div className="grid">
      <div className="card">
        <h2>Manager Room</h2>
        <p style={{marginTop:6}}><small>Full visibility of security gadgets + platform activity.</small></p>
        <div style={{height:10}} />
      ...
      <div className="card">
        <h3>Security Posture (Platform)</h3>
        <SecurityPostureDashboard
          score={84}
          coverage={{ phishing: 89, malware: 74, accountTakeover: 93, fraud: 70 }}
        />
      </div>
