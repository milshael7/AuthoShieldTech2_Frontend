...
// Lazy load any additional heavy components
const TradingRoom = lazy(() => import("./TradingRoom.jsx"));
const MarketRoom = lazy(() => import("./MarketRoom.jsx"));
const AnalyticsRoom = lazy(() => import("./AnalyticsRoom.jsx"));
...
const styles = {
 ...
 nav: { display: "flex", background: "#0b101a", padding: "0 20px", borderBottom: "1px solid #ffffff05", overflowX: "auto", position: 'sticky', top: 0 },
