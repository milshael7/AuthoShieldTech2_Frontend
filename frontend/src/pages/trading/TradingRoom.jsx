...
export default function TradingRoom() {
 ...
 return [...prev.slice(0, -1), updated]; // Replace last element directly
 });
 }, [livePrice]);
 ...
 setErrorMessage("Failed to stop the trading session. Please try again."); // User-friendly message
 } finally {
 setLoading(false);
 }
 };
...
const styles = {
 ...
 errorMessage: { color: "#ea3943", marginTop: "10px", fontWeight: 'bold' } // Style for error messages
};
